...
```
Output Image: <br>
<img src="Images/Top10_repos.png" height="50%" width="50%"> <br>
...
<img src="Images/star_today.png" height="80%" width="80%"> <br>
(ii) Creating the table for trending R-repositories on weekly basis: <br>
<img src="Images/star_week.png" height="80%" width="80%"> <br>
(iii) Creating the table for trending R-repositories on monthly basis: <br>
<img src="Images/stars_month.png" height="80%" width="80%"> <br>
